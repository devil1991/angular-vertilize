...
var realHeight=clone.innerHeight();clone["remove"]();return realHeight};scope.$watch(getMyRealHeight,function(myNewHeight){if(myNewHeight)parent.updateMyHeight(myIndex,myNewHeight)});scope.$watch(parent.getTallestHeight,function(tallestHeight){if(tallestHeight)element.css("height",tallestHeight)})}}}])})();